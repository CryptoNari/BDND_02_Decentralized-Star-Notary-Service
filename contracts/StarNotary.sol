...
contract StarNotary is ERC721 {
    ...
    string public name = "SleddogStars";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {    
        ...
        require (ownerOf(_tokenId1)== msg.sender || ownerOf(_tokenId2)== msg.sender, "You don't own either of the Tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(tokenOwner == msg.sender, "You are not the owner of the Token");
